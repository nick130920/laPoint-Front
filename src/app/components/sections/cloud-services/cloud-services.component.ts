    ...
    <section class="py-16 bg-gradient-to-b from-sky-600 to-sky-700">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 class="text-5xl font-bold text-center mb-2">
          ...
          <span class="text-cyan-300">Nube</span>
        </h2>
        <p class="text-xl text-white text-center mb-12">Pay-As-You-Go</p>
          ...
          @for (plan of plans; track $index) {
            <div class="bg-white rounded-3xl p-8 shadow-xl">
              ...
              <div class="text-center mb-8">
                <span class="text-6xl font-bold text-black">$ {{plan.price}}</span>
